...
_INSTRUCTIONS = """
    ...
    The architecture diagram and business context will be provided to you as input.
    ...
    6. Use get_phase_6_guidance() then add_threat() for at least one threat per STRIDE category.
